...
def test_technical_fit_api_returns_generated_rows_for_opportunity():
    with TemporaryDirectory() as tmp:
        ...
        with fit_path.open("w", newline="", encoding="utf-8") as handle:
            ...
            writer.writeheader()
            writer.writerow({
                "procurement_event_id": "EV-1", "tender_reference": "T-1", "faram_product_id": "F-1",
        ...
        opportunity_technical_fit.DEFAULT_PATH = fit_path
        commercial_crm.sync_opportunities([
            {
                "opportunity_id": "OPP-EV-1",
...
def test_technical_fit_api_is_empty_for_account_level_opportunity():
    with TemporaryDirectory() as tmp:
        ...
        commercial_crm.sync_opportunities([
            {
                "opportunity_id": "OPP-ACTION-1",
                "action_id": "ACTION-1",
                "account_name": "Test Account",
                "commercial_account_priority_score": "70.0",
