...
class ManufacturerIntelligenceTests(unittest.TestCase):
    def test_explicit_manufacturer_label_is_extracted(self):
        ...
        self.assertEqual(manufacturer, "Sysmex Corporation")
        self.assertEqual(brand, "Sysmex")
    ...
    def test_structured_fields_are_supported(self):
        ...
        self.assertEqual((manufacturer, brand, status), ("Abbott Laboratories", "Alinity", "EXPLICIT"))
    ...
    def test_supplier_name_is_never_used_as_manufacturer(self):
        ...
        self.assertEqual((manufacturer, brand, status), ("", "", "NONE"))

    def test_conflicting_labels_are_ambiguous(self):
        manufacturer, brand, status = extract_explicit_manufacturer_brand(
            notice_text="Manufacturer: Sysmex Corporation; Manufacturer: Mindray"
        )
        self.assertEqual((manufacturer, brand, status), ("", "", "AMBIGUOUS"))
    ...
    def test_empty_catalogue_does_not_claim_principal_gap(self):
    ...
    def test_catalogue_match_and_gap_are_distinguished(self):
        events = [
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with catalogue.open("w", newline="", encoding="utf-8") as handle:
                ...
                writer.writeheader()
                writer.writerow({"faram_product_id": "F-1", "product_name": "Hematology Analyzer", "manufacturer_name": "Sysmex Corporation"})
