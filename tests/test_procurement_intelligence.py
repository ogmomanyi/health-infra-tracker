...
class ProcurementIntelligenceTests(unittest.TestCase):
    def test_event_id_is_stable(self):
        self.assertEqual(
            stable_event_id("World Bank", "A-1", "Lab equipment"),
            stable_event_id("World Bank", "A-1", "Lab equipment"),
        )

    def test_round_trip_csv(self):
        event = ProcurementEvent(
            "proc_1", "World Bank", "https://example.test", "A-1", "Lab equipment",
    ...
    def test_explicit_iati_identifier_is_confirmed(self):
        event = ProcurementEvent(
            "proc_2", "World Bank", "", "A-2", "Unrelated title", "Unknown", "Uganda",
    ...
    def test_country_and_equipment_alone_do_not_match(self):
        event = ProcurementEvent(
            "proc_3", "World Bank", "", "A-3", "Supply notice", "", "Kenya", "", "",
            "Laboratory Equipment", "Analyzers",
        )
        projects = [{
            "iati_identifier": "P-3",
    ...
    def test_weak_text_does_not_force_a_match(self):
        event = ProcurementEvent(
            "proc_4", "World Bank", "", "A-4", "General supplies", "", "Kenya", "", "",
            "Medical Devices", "",
        )
        projects = [{
            "iati_identifier": "P-4",
