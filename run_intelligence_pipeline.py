...
entity-resolution IDs and prevents the builder from replacing the canonical
organisation_entities/organisation_aliases tables.
"""
...
def canonical_map():
    ...
    for org_ref, entity_id in conn.execute(
        ...
        by_ref[org_ref.strip().lower()] = entity_id
